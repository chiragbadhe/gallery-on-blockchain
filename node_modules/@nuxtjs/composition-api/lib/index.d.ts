...
declare type ReactiveHead<T = Record<string, unknown>> = UnwrapRef<Ref<MetaInfo & T>>;
 ...
 */
declare const useMeta: <T extends MetaInfo>(init?: T | undefined) => ToRefs<Pick<MetaInfoMapper<Required<MetaInfo>>, "base" | "link" | "title" | "htmlAttrs" | "headAttrs" | "bodyAttrs" | "meta" | "style" | "script" | "noscript" | "__dangerouslyDisableSanitizers" | "__dangerouslyDisableSanitizersByTagID" | "changed" | "afterNavigation"> & {
